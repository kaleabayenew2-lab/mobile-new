...
class _AgentRegisterPageState extends State<AgentRegisterPage>
  ...
  void _clearForm() {
    setState(() {
      ...
      _selectedOwnership = 'Private';
      _isEmergencyAgent = false;
        ...
        child: Form(
          ...
          child: IntrinsicHeight(
            child: Column(
              ...
              // Register Button (removed Hero wrapper to avoid conflicts)
              SizedBox(
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            mini: true,
            heroTag: 'refresh_location_fab',  // Unique tag
            onPressed: _getCurrentLocation,
          ...
          FloatingActionButton(
            mini: true,
            heroTag: 'clear_form_fab',  // Unique tag
